...
abstract final class PosColors {
  ...
  static const whiteGray = Color(0xffe7e7e7);
  ...
  static const darkPurple = Color(0xcc8f5aff);
  ...
  static const midnightBlack = Color(0xff191970);
  ...
  static const lightMagenta = Color(0xffffbbff);
